...
class ViewReceivedRejectedReplacementRequests extends Component{
    state={
        requests:[]
    }
    componentDidMount(){
    console.log("in view")
        axios.get('http://localhost:5000/academic/receivedRejectedReplacementRequest',
        {
            headers:{
            ...
            return(
                <div className="containAll">
                 ...
                 <div className="containDrop">
                    ...
                    <Dropdown.Item active><Link to="/ViewReceivedRejectedReplacementRequests">Rejected</Link></Dropdown.Item>
...
export default ViewReceivedRejectedReplacementRequests