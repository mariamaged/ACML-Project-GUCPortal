...
class OneCourseCoverage extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:5000/Instructor/coursecoverage/' + courseID, {
            headers: {
            ...
            .catch(error => {
                ...
                console.log('Error with getting course coverage for a certain course that you are assigned.');
                console.log(error);
            });
    }
