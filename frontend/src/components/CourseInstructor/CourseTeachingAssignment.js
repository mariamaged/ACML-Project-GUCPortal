...
class CourseTeachingAssignment extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:5000/Instructor/slotsAssignment/' + courseID, {
            headers: {
            ...
            .catch(error => {
                ...
                console.log('Error with getting teaching assignment for a certain course that you are assigned');
                console.log(error);
            });
    }
