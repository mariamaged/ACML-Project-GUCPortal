...
class ViewPendingMaternityRequests extends Component{
    state={
        requests:[]
    }
    componentDidMount(){
    console.log("in view")
        axios.get('http://localhost:5000/academic/pendingMaternityRequest',
        {
            headers:{
            ...
            return(
                <div className="containAll">
                 ...
                 <div className="containDrop">
                    ...
                    <Dropdown.Item active><Link to="/ViewPendingMaternityRequests">Pending</Link></Dropdown.Item>
...
export default ViewPendingMaternityRequests