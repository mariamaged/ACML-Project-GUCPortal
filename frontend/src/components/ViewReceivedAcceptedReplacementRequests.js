...
class ViewReceivedAcceptedReplacementRequests extends Component{
    state={
        requests:[]
    }
    componentDidMount(){
    console.log("in view")
        axios.get('http://localhost:5000/academic/receivedAcceptedReplacementRequest',
        {
            headers:{
            ...
            return(
                <div className="containAll">
                 ...
                 <div className="containDrop">
                    ...
                    <Dropdown.Item active><Link to="/ViewReceivedAcceptedReplacementRequests">Accepted</Link></Dropdown.Item>
...
export default ViewReceivedAcceptedReplacementRequests