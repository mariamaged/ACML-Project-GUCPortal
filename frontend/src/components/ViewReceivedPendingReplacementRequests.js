...
class ViewReceivedPendingReplacementRequests extends Component{
    state={
        requests:[]
    }
    componentDidMount(){
    console.log("in view")
        axios.get('http://localhost:5000/academic/receivedPendingReplacementRequest',
        {
            headers:{
            ...
            return(
                <div className="containAll">
                 ...
                 <div className="containDrop">
                    ...
                    <Dropdown.Item active><Link to="/ViewReceivedPendingReplacementRequests">Pending</Link></Dropdown.Item>
...
export default ViewReceivedPendingReplacementRequests