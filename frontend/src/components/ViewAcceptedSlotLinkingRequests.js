...
class ViewAcceptedSlotLinkingRequests extends Component{
    state={
        requests:[]
        ,warning:""
    }
    ...
    console.log("in maternity view")
        axios.get('http://localhost:5000/academic/acceptedSlotLinkingRequest',
        {
            headers:{
...
export default ViewAcceptedSlotLinkingRequests