...
class ViewRejectedCompensationRequests extends Component{
    state={
        requests:[]
        ,warning:""
    }
    ...
    console.log("in maternity view")
        axios.get('http://localhost:5000/academic/rejectedCompensationRequest',
        {
            headers:{
        ...
        var empty=["one"]
            ...
            <span className="maternityH">Compensation Requests</span>
                ...
                <Dropdown.Toggle id="dropdown-custom-2" className="pickBtn">Request Type</Dropdown.Toggle>
                    ...
                    <Dropdown.Item active><Link to="/ViewRejectedCompensationRequests">Rejected</Link></Dropdown.Item>
...
export default ViewRejectedCompensationRequests