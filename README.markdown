...
slot number (1st,2nd,etc…)
slot date ("2020-12-09)
slot location (office/hall id eg. “C7.101”)
...
Request type: POST
Request body: user must input
sickDay ( eg. “2020-12-20”)
medicalDoc ( a string that has link for drive for example)
(OPTIONAL) reason for request
Example request body:
  { 
  "sickDay":"2020-12-24",
...
maternityDoc ( a string that has link for drive for example)
(OPTIONAL) reason for request
Example request body:
...
Course ID: csen33
Reason: 
Submission date: Thu Dec 24 2020 20:21:37 GMT+0200 (Easter
